 ...
 *  Compilation:  javac edu.princeton.cs.algs4.StdDraw.java
 *  Execution:    java edu.princeton.cs.algs4.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code edu.princeton.cs.algs4.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code edu.princeton.cs.algs4.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">edu.princeton.cs.algs4.StdDraw.java</a>
 ...
 *           edu.princeton.cs.algs4.StdDraw.setPenRadius(0.05);
 *           edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.BLUE);
 *           edu.princeton.cs.algs4.StdDraw.point(0.5, 0.5);
 *           edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.MAGENTA);
 *           edu.princeton.cs.algs4.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code edu.princeton.cs.algs4.StdDraw.line()} and {@code edu.princeton.cs.algs4.StdDraw.point()}
 *  draw lines and points; the methods {@code edu.princeton.cs.algs4.StdDraw.setPenRadius()}
 *  and {@code edu.princeton.cs.algs4.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code edu.princeton.cs.algs4.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code edu.princeton.cs.algs4.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code edu.princeton.cs.algs4.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code edu.princeton.cs.algs4.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   edu.princeton.cs.algs4.StdDraw.setFont(font);
 *   edu.princeton.cs.algs4.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code edu.princeton.cs.algs4.StdDraw.clear(edu.princeton.cs.algs4.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   edu.princeton.cs.algs4.StdDraw.setScale(-2, +2);
 ...
 *       edu.princeton.cs.algs4.StdDraw.filledCircle(x, y, 0.05);
 *       edu.princeton.cs.algs4.StdDraw.filledCircle(-x, -y, 0.05);
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code edu.princeton.cs.algs4.StdDraw.BLACK}, {@code edu.princeton.cs.algs4.StdDraw.BLUE}, {@code edu.princeton.cs.algs4.StdDraw.CYAN},
     * {@code edu.princeton.cs.algs4.StdDraw.DARK_GRAY}, {@code edu.princeton.cs.algs4.StdDraw.GRAY}, {@code edu.princeton.cs.algs4.StdDraw.GREEN},
     * {@code edu.princeton.cs.algs4.StdDraw.LIGHT_GRAY}, {@code edu.princeton.cs.algs4.StdDraw.MAGENTA}, {@code edu.princeton.cs.algs4.StdDraw.ORANGE},
     * {@code edu.princeton.cs.algs4.StdDraw.PINK}, {@code edu.princeton.cs.algs4.StdDraw.RED}, {@code edu.princeton.cs.algs4.StdDraw.WHITE}, and
     * {@code edu.princeton.cs.algs4.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to edu.princeton.cs.algs4.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
