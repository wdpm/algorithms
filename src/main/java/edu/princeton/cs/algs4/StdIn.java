 ...
 *  Compilation:  javac edu.princeton.cs.algs4.StdIn.java
 *  Execution:    java edu.princeton.cs.algs4.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code edu.princeton.cs.algs4.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code edu.princeton.cs.algs4.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">edu.princeton.cs.algs4.StdIn.java</a>
 ...
 *  <a href = "http://docs.oracle.com/javase/7/docs/api/java/util/Scanner.html#number-syntax">ScannerTest</a>,
 ...
 *      edu.princeton.cs.algs4.SystemOutPrintTest.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (edu.princeton.cs.algs4.StdIn.hasNextChar()) {
 *      char c = edu.princeton.cs.algs4.StdIn.readChar();
 *      edu.princeton.cs.algs4.SystemOutPrintTest.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *      String line = edu.princeton.cs.algs4.StdIn.readLine();
 *      edu.princeton.cs.algs4.SystemOutPrintTest.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = edu.princeton.cs.algs4.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with ScannerTest.</b>
 *  {@code edu.princeton.cs.algs4.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code edu.princeton.cs.algs4.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code edu.princeton.cs.algs4.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code edu.princeton.cs.algs4.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code edu.princeton.cs.algs4.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code edu.princeton.cs.algs4.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code edu.princeton.cs.algs4.StdIn} preceded {@code ScannerTest}; when
 *  {@code ScannerTest} was introduced, this class was re-implemented to use {@code ScannerTest}.
 *  <p>
 *  <b>Using standard input.</b>
 *  Standard input is a fundamental operating system abstraction on Mac OS X,
 *  Windows, and Linux.
 *  The methods in {@code edu.princeton.cs.algs4.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code edu.princeton.cs.algs4.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to edu.princeton.cs.algs4.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to edu.princeton.cs.algs4.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to edu.princeton.cs.algs4.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to edu.princeton.cs.algs4.StdIn
    
    
    // do this once when edu.princeton.cs.algs4.StdIn is initialized
    static {
        resync();
    }

    /**
     * If edu.princeton.cs.algs4.StdIn changes, use this to reinitialize the scanner.
     */
